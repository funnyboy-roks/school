...
\begin{enumerate}[1.]
    ...
    \item Does every regular expression define a language? \\
        ANSWER: Yes, for any regular expression we can construct its language
        ...
        \begin{enumerate}[a)]
            \item Draw a finite automaton for this language. \\
                ...
                \begin{tikzpicture}[node distance={20mm}, main/.style = {draw, circle}] 
                    ...
                    \node[main] (U) [below right of=Y] {$U$};
                    \node[main] (Z) [above right of=Y] {$+Z$};
                    ...
                    \path[-Latex] (U) edge [out=90,in=45,looseness=5] node[above] {a,b} (U);
                    
                    \path[-Latex] (Y) edge node[right] {a} (U);
    ...
    \item Build a finite automaton that accepts: Language ($\bm{(a (a+b)^* b) +
        ...
        \begin{tikzpicture}[node distance={20mm}, main/.style = {draw, circle}] 
            ...
            \path[-Latex, bend left=10mm] (U) edge node[above] {a} (Y);
            \path[-Latex, bend left=10mm] (Y) edge node[above] {b} (U);
            ...
            %\path[->] (1) edge node[above] {a} (2);
            %\path[->] (1) edge [out=90,in=180,looseness=10] node[above] {a} (1);
            \path[-Latex] (U) edge [out=45,in=315,looseness=5] node[right] {b} (U);
            \path[-Latex] (V) edge [out=315,in=45,looseness=5] node[right] {a} (V);
        \end{tikzpicture}
