...
public class BinarySearchTreeOriginal<T> {

    public static void main(String[] args) {
//        BinarySearchTree<Integer> tree = new BinarySearchTree<>(Comparator.comparingInt(String::length));
        BinarySearchTreeOriginal<Integer> tree = new BinarySearchTreeOriginal<>(Integer::compare);
        tree.add(2);
        tree.add(12);
        tree.add(35);
        tree.add(8);
...
//        System.out.println(tree);
    ...
    public BinarySearchTreeOriginal(Comparator<T> comparator) {
        this.root = null;
        this.comparator = comparator;
    }

    public BinarySearchTreeOriginal(Comparator<T> comparator, T rootValue) {
    ...
    private static final class Node<T> {
        ...
        public boolean remove(T value, BinarySearchTreeOriginal<T> tree) {
            if (this.left() != null) {
